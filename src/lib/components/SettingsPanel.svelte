			...
			<div class="section">
				...
				<div class="control">
					...
					<input
						id="draco"
						type="checkbox"
						bind:checked={$settings.draco}
						on:change={toggleDraco}
					/>
				</div>
				...
				<div class="control">
					...
					<input
						id="meshopt"
						type="checkbox"
						bind:checked={$settings.meshopt}
						on:change={toggleMeshopt}
					/>
				</div>
			...
			<div class="section">
				...
				<div class="control">
					<div class="label-group">
						...
						<div class="tooltip-icon" style="color: #fbbf24;">
							<!-- Warning color for instance -->
							<Info size={14} />
							<div class="tooltip-content">
